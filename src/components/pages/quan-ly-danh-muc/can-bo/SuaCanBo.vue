<template>
  <b-modal :title="'Sửa hồ sơ cán bộ'"
           @hidden="hideModal"
           centered
           no-close-on-backdrop
           ref="modalCapNhatHoSoCanBo"
           size="xl">
          ...
          <b-col cols="10">
            ...
            >
              <b-form-group
                ...
                label-for="donVi"
              >
                <cay-don-vi :class-valid="validationContext.invalid && validationContext.validated"
...
<script>
  ...
  import { BO_QUA_BUTTON_LABEL, PERMISSION_NAME, ROUTE_NAME } from "@/constants/constants";
  ...
  export default {
    ...
    methods: {
      hideModal() {
        this.$refs["modalCapNhatHoSoCanBo"].hide();
        this.$emit("hidden");
      },
      onSuccess() {
        this.hideModal();

...
export default {
  name: "DanhSachQuyenKhongThuocNguoiDung",
  components: {
    BaseLoadingTable
  },
  data() {
    return {
      danhSachQuyenTrongNguoiDung: [],
      danhSachQuyenNoiBo: [],
  ...
  computed: {
    ...mapGetters({
      danhSachQuyenKhongThuocNguoiDung: "user/danhSachQuyenKhongThuocNguoiDung"
    }),
    fieldName() {
      return this.getFieldName();
    },
    hasPageData() {
      return !_isEmpty(this.danhSachQuyenKhongThuocNguoiDung);
    },
    danhSachQuyenDaChon: {
      get: function() {
    ...
    danhSachQuyenKhongThuocNguoiDung: {
      handler() {
        this.danhSachQuyenNoiBo = this.layDanhSachQuyenNoiBo(
          this.danhSachQuyenKhongThuocNguoiDung
        );
  ...
  methods: {
    ...
    themQuyenVaoNguoiDungThanhCong() {
      this.$bvModal.hide("them-quyen-trong-nguoi-dung");
      this.layDanhSachQuyenTrongHeThong();
    },
    ...
    themQuyenVaoNguoiDung() {
      ...
      this.$store
        ...
        .then(() => {
          ...
          $vm.$emit("themQuyenVaoNguoiDungThanhCong");
        })
        .catch(error => {
          $vm.$toasted.clear();
          if (
    ...
    layDanhSachQuyenNoiBo(danhSachQuyenKhongThuocNguoiDung) {
      if (_isEmpty(danhSachQuyenKhongThuocNguoiDung)) {
        return [];
      }
      return danhSachQuyenKhongThuocNguoiDung.map(item => {
        return {
          checkbox: null,
